def add_me_to_the_queue(express_queue, normal_queue: list[str], ticket_type: int, person_name: str) -> list[str]:
...
def find_my_friend(queue: list[str], friend_name: str):
    """Return the position of the person's name in the queue.
